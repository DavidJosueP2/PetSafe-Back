...
export class Cirugia extends BaseAuditEntity {
  ...
  @ManyToOne(() => Atencion, (a) => a.cirugias, { onDelete: 'CASCADE' })
  ...
  @Column({ name: 'fecha_programada', type: 'timestamp without time zone', nullable: true })
  fechaProgramada!: Date | null;

  @Column({ name: 'fecha_realizada', type: 'timestamp without time zone', nullable: true })
  ...
  @Column({ name: 'indicaciones_postoperatorias', type: 'text', nullable: true })
